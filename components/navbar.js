...
const Nav = () => {
  ...
  return (
    <div className="navbar shadow bg-gradient-to-r from-black to-coolGray-900 text-neutral-content sticky top-0 z-50">
      ...
      <div className="flex-none  px-2 mx-2 ">
        <div className="flex items-stretch">
          ...
          <label
            htmlFor="my-drawer"
            className="btn btn-primary btn-sm  rounded-btn normal-case mr-2"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"

    ...
    <div className="z-50 mx-4 py-3 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 ">
      <div className="relative flex items-center justify-between">
        <Link href="/">
          ...
          >
            <span className="pl-2 text-xl font-bold tracking-wide text-blue-500 uppercase">
              Edu<span className="text-gray-700">city</span>
            </span>
          </a>
        </Link>
                ...
                <nav>
                  <ul className="space-y-4">
                    ...
                    <li>
                      <a
                        href="/"
                        className="inline-flex items-center justify-center w-full h-12 px-6 font-medium tracking-wide text-white transition duration-200 rounded shadow-md bg-blue-500 hover:bg-blue-400 focus:shadow-outline focus:outline-none"
                        aria-label="Sign up"
                        title="Sign up"
                      >
                        Sign up

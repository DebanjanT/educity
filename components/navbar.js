    ...
    <div className="navbar shadow-lg bg-neutral text-neutral-content">
      ...
      <div className="flex-none  px-2 mx-2 ">
        <div className="flex items-stretch">
          ...
          <button tabindex="0" className="btn btn-sm hover:rounded-t-md hover:rounded-b-none hover:bg-white hover:text-accent bg-coolGray-700 normal-case">My Account</button> 
          <div tabindex="0" className="p-1 -mt-1  menu dropdown-content bg-base-100  w-52">
          <Link href="/user">
